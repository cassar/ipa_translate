...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'ipa-volt.com'
  config.app_name = 'Ipa_volt'
  config.mailer.from = 'Ipa_volt <no-reply@ipa-volt.com>'
  ...
  #
  config.app_secret = 'MpxvbUEgneWbArwiw9SoI29rVcSmE7mNYAASv8zNij9EJwoo82_SuSQygXsqMUG_6bk'
